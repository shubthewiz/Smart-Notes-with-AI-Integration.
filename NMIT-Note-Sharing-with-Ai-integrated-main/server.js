...
const seedDatabase = async () => {
    try {
        ...
        if (noteCount === 0) {
            ...
            const dummyTxtPath = path.join(__dirname, "public/uploads", "demo_note.txt");
            if (!fs.existsSync(dummyTxtPath)) fs.writeFileSync(dummyTxtPath, "This is a demo note generated by the AI assistant.");
            ...
            const dummyCode = new Code({
                title: "Hello World in Python",
                language: "python",
                code: "print('Hello, World from AI!')",
                userId: testUser._id
            });
            await dummyCode.save();
